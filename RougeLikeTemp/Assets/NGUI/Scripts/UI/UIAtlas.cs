...
public class UIAtlas : MonoBehaviour
{
    ...
    [HideInInspector][SerializeField] Material grayMaterial;
    [HideInInspector][SerializeField] Material brightMaterial;
    ...
    private const string _grayShader = "Unlit/Transparent Colored";
    //private const string _grayShader = "Unlit/Transparent Colored (Gray)";
    /// <summary>
    ...
    public Material spriteMaterial
	{
		get
		{
            ...
            else
            {
                ...
                /*if(material != null)
                {
                    if(material.shader.name != _grayShader)
                    {
                        material.shader = Shader.Find(_grayShader);
                    }
                }*/
            }
    ...
    public Material spriteGrayMaterial
    {
        get
        {
            ...
            {
                grayMaterial = new Material(spriteMaterial);
                grayMaterial.SetFloat("_EffectAmount", 1);
            }
    ...
    public Material spriteBrightMaterial
    {
        get
        {
            if (brightMaterial == null)
            {
                brightMaterial = new Material(spriteMaterial);
                brightMaterial.SetFloat("_Intensity", 1.5f);
            }
