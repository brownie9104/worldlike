...
public class EventDelegate
{
	...
	public class Parameter
	{
        ...
        public float CustomValueFloat;
        public bool CustomValueBool;
		...
		public object value
		{
			get
			{
                if (IsCustomValue == true)
                {
                    ...
                    {
                        return CustomValueInt;
                    }
                    else if (expectedType == typeof(float))
                    {
                        return CustomValueFloat;
                    }
        ...
        { 
            ...
            if (mValue != null) return mValue; return obj; } 
        }
#if UNITY_EDITOR || !UNITY_FLASH
